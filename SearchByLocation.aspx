<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchByLocation.aspx.cs" Inherits="TopMess" %>
...
<body>
     ...
     <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-lg-auto text-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="TopMess.aspx" >Top Mess</a>
 ...
 <div style="background-color: #E9ECEF; color: #e9ecef; position: relative;">         
    ...
    <div class="dropdown"><span style="color: #800000; font-weight: bold; font-size: medium; text-decoration: blink"> Filter:  </span>
          <asp:DropDownList ID="DropDownList1" runat="server" 
            class="btn btn-default dropdown-toggle" 
            onselectedindexchanged="DropDownList1_SelectedIndexChanged" 
            AutoPostBack="True" >
              <asp:ListItem>Select</asp:ListItem>
              <asp:ListItem Value="Yes" >Veg</asp:ListItem>
    ...
    <div style=" position: absolute; top: 8px; right: 16px; font-size: 18px;">
        <%--<asp:Button ID="btnlocation"  runat="server" Text="Change Location" 
            onclick="btnlocation_Click" BackColor="#FFCCCC" BorderColor="#33CC33" 
            BorderStyle="Groove" ForeColor="#FF0066" />--%>
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="menu-grids mt-4">
                                <div class="row t-in">
                                    <div class="col-lg-8 text-info-sec">
                                        <!--/job1-->
                                        <div align="center"><strong style="font-weight: 400; color: #000000; font-size: 2em"><asp:Label ID="lbltitle" runat="server" Text="List of Mess"></asp:Label></strong></div>
                            ...
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info"><asp:Label ID="lblveg" runat="server" Text=""></asp:Label>
                                    <h4><a href="#" style="float: left"><%#Eval("mess_name") %></a></h4>&nbsp;&nbsp;<a style="color: #006600; font-weight: bold; font-size: medium">[ <%#Eval("veg").ToString()=="Yes"?"Veg":"Non-Veg" %> ]</a>
