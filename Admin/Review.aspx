...
<body>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            ...
                            <div class="col-md-9 emply-info">
                                <div class="emply-img">
                                    <img src="../Team/user.png" alt="" class="img-fluid">
                                </div>
    ...
    <div class="rating1">
        ...
        <ContentTemplate>
            <cc1:Rating ID="Rating2" runat="server" StarCssClass="starRating" EmptyStarCssClass="EmptyStar" FilledStarCssClass="FilledStar" WaitingStarCssClass="EmptyStar" CurrentRating='<%#Eval("ratting") %>' MaxRating="5">
            </cc1:Rating>
           <%-- <asp:Label ID="Label1" runat="server" Text='<%#Eval("review") %>' Font-Size="Medium" Font-Bold="True"></asp:Label>--%>
     </ContentTemplate>
        </asp:UpdatePanel>
    </div>
                             ...
                             <div class="col-md-3 job-single-time text-right">
                                                ...
                                                <asp:Button ID="btndelete" runat="server" Text="Delete" class="btn btn-danger " onclick="Button1_Click" UseSubmitBehavior="False"></asp:Button>
                                            </div>
                       ...
                       <asp:Repeater ID="Repeater2" runat="server" DataSourceID="SqlDataSource_review">
                            ...
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info"><asp:Label ID="lblveg" runat="server" Text=""></asp:Label>
                                    <h4><a href="#" style="float: left"><%#Eval("V_name") %></a> </h4><a style="color: #006600; font-weight: bold; font-size: medium">784512963</a> 
