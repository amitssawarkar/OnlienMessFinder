<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewMess.aspx.cs" Inherits="Admin_NewMess" %>
...
<body>
    ...
    <!-- banner-inner -->
    <%--<div style="background-image: url('../images/1(b1).jpg')">--%>
    <div>
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
                       ...
                       <br />
                         ...
                         <div class="">
                            <div style="margin: auto; width: 50%; float: left">
                                <asp:TextBox ID="txtVegRateHalf" placeholder="Half Veg Rate" runat="server" required=""></asp:TextBox>
							</div> 

                            <div style="padding-left: 20px; width: 50%; float: left">
                                <asp:TextBox ID="txtVegRateFull" placeholder="Full Veg Rate" runat="server" required=""></asp:TextBox>
							</div> 
                         </div>
                         <br />
                         <br />
                         <br />
                            ...
                            <div class="">
                                ...
                                <div style="margin: auto; width: 50%; float: left">
                                <asp:TextBox ID="txtNonVegRateHalf" placeholder="Half NonVeg Rate" runat="server" required=""></asp:TextBox>
							</div>

                            <div style="padding-left: 20px; width: 50%; float: left">
                                <asp:TextBox ID="txtNonVegRateFull" placeholder="Full NonVeg Rate" runat="server" required=""></asp:TextBox>
							</div>
						...
						<div class="">
                            ...
                            <br />
                            	<div class="">
                                <asp:TextBox ID="txtnote" placeholder="Note" runat="server" TextMode="MultiLine"></asp:TextBox>
							</div>
                            <br />
                            <asp:Label ID="Label1" runat="server" Text="Dimensions of uploded file must be (150 x 150)" ForeColor="#FF6600"></asp:Label>
                            <br />
                            	<div class="">

                                <asp:FileUpload ID="FileUpload_mess" runat="server"></asp:FileUpload>
							</div> 
                            <br />
                               <div class="">
                            ...
                            <br />
                           <div >
                           <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn btn-danger" onclick="btnSubmit_Click" style="width: 200px"/>
                           </div>
