    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       //// lblcontact.Text =
        if (!IsPostBack)
        {
            ...
            cmd.CommandText = "SELECT * FROM [MessList] where area_cover like '%Pote Township%'";
            ...
            {
                string str = "SELECT * FROM [MessList] where area_cover like '%Pote Township%'";
...
//sign in 
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
       // string str = "SELECT * FROM [MessList] where area_cover like '%" + Request.QueryString["area"].ToString() + "%'";
        string str = "SELECT * FROM [MessList] where veg ='" + DropDownList1.SelectedValue.ToString() + "'and area_cover like '%" + Request.QueryString["area"].ToString()+"%'";
        SqlDataSource1.SelectCommand = str;
       // Response.Redirect("Default.aspx");
    }
}