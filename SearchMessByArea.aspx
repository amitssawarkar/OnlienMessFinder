<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchMessByArea.aspx.cs" Inherits="TopMess" %>
 ...
 <div style="background-color: #E9ECEF; color: #e9ecef; position: relative;">         
  ...
  <div style="clear: both"></div>
    ...
    <section class="banner-bottom-wthree pb-lg-5 pb-md-4 pb-3">
        <div class="container">
        <div style=" position: absolute; top: 200px; right: 16px; margin-left:0px; font-size: 18px;">
        <a href="Default.aspx" class="aply-btn" >Change Location</a>
        </div>
            <div class="inner-sec-w3ls py-lg-5  py-3">
			<!---728x90--->
                            ...
                            <div class="menu-grids mt-4">
                                <div class="row t-in">
                                    <div class="col-lg-8 text-info-sec">
                                        ...
                                        <div align="center"><h5 ><strong style="font-weight: bolder; color: #000000; font-size: 1.5em"><asp:Label ID="lbltitle" runat="server" Text=""></asp:Label></strong></h5></div>
